    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    models.Q(("payment_id__isnull", True), ("status__in", [1, 2, 3])),
                    models.Q(("payment_id__isnull", False), ("status__in", [4, 5])),
                    _connector="OR",
                ),
                name="reservations_reservation_completed_payment_must_have_payment_id",
            ),
        ),
    ]
